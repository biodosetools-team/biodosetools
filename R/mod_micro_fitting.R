...
microFittingUI <- function(id, label) {
        ...
        fluidRow(
          column(
            ...
            mySwitchInput(
              ...
              onStatus = "options",
              width = "100%",
              sideLabel = "Only provide total number of micronuclei",
              value = FALSE
            ),
        ...
        topButton = div(
          ...
          bs4MyModal(
            ...
            conditionalPanel(
              ...
              ns = ns,
              include_help("help/micro/fitting_options_model.md")
            )#,
            # conditionalPanel(
            #   condition = "input.help_fitting_options_option == 'decision_thresholds'",
            #   ns = ns,
            #   include_help("help/fitting/fitting_options_decision_thresholds.md")
            # )
          )
        ),
