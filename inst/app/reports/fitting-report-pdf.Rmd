...
data$`$u$` <- kableExtra::cell_spec(data$`$u$`, background = ifelse(data$`$u$` > 1.96, "#ffc0cb", "white"))
...
`r 
if (aberr_module == "translocations") {
  paste0("The genomic conversion factor to full genome is ", as.character(round(genome_fraction, 3)), ".")
}
`
