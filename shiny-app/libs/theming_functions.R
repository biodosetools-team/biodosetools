...
#' @note This logo design was inspired from \url{http://www.dataseries.org/}.
#' @export
shinyDashboardAltLogoDIY <- function(fontFamily = 'sans-serif', boldText, mainText, textSize = 15, badgeText, badgeTextColor, icon, badgeTextSize = 2, badgeBackColor, badgeBorderRadius = 3) {
...
# Function: shinyDashboardButtonsTheme ----------------------------------------
#' Creates a custom theme object for a shinydashboard application
#'
#'
#' @return HTML code. Theme for a shinydashboard application.

shinyDashboardButtonsStatus <- function(home_color, home_color_hover, home_color_border,
