...
`r if (params$assessment == "partial") {"### Dose recieved by the irradiated fraction"}`
```{r echo=FALSE}
...
`r if (params$assessment == "partial") {"### Initial fraction of irradiated cells"}`
```{r echo=FALSE}
if (params$assessment == "partial") {
...
`r if (params$assessment == "hetero") {"### Observed fraction of irradiated cells and its yield"}`
```{r echo=FALSE}
...
`r if (params$assessment == "hetero") {"### Dose recieved by the irradiated fraction"}`
```{r echo=FALSE}
if (params$assessment == "hetero") {
...
`r if (params$assessment == "hetero") {"### Initial fraction of irradiated cells"}`
```{r echo=FALSE}
if (params$assessment == "hetero") {
